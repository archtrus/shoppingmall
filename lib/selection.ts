...
export const selectionReasonCodes = [
  ...
  { value: "HEAVY_OR_BULKY", label: "대형/중량 상품" },
...
export const riskChecklistCodes = [
  { value: "FOOD_HEALTH_SUPPLEMENT", label: "식품/건기식 가능성" },
  ...
  { value: "CHILDREN_PRODUCT", label: "어린이제품 가능성" },
  ...
  { value: "INSUFFICIENT_INFO", label: "이미지/상세정보 부족" },
